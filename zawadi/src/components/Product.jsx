  ...
  return (
    <div>
      <div className='border border-[#e4e4e4] h-[300px] mb-4 relative overflow-hidden group transition'>
        ...
        <div className='absolute bottom-6 right-11 group-hover:right-5 bg-red-500/40 p-2 flex flex-row items-center justify-center gap-y-2 opacity-0 group hover:opacity-100 transition-all duration-250'>
          <button>
